...
namespace
{
  ...
  class CurrencyService final : public oteldemo::CurrencyService::Service
  {
                                  ...
                                  GetSupportedCurrenciesResponse *response) override
    {
      ...
      auto span =
          get_tracer("currencyservice")->StartSpan(span_name, {{SemanticConventions::kRpcSystem, "grpc"}, {SemanticConventions::kRpcService, "oteldemo.CurrencyService"}, {SemanticConventions::kRpcMethod, "GetSupportedCurrencies"}, {SemanticConventions::kRpcGrpcStatusCode, 0}}, options);
                   ...
                   Money *response) override
    {
      ...
      auto span =
          get_tracer("currencyservice")->StartSpan(span_name, {{SemanticConventions::kRpcSystem, "grpc"}, {SemanticConventions::kRpcService, "oteldemo.CurrencyService"}, {SemanticConventions::kRpcMethod, "Convert"}, {SemanticConventions::kRpcGrpcStatusCode, 0}}, options);
      auto scope = get_tracer("currencyservice")->WithActiveSpan(span);
      ...
      {
        span->AddEvent("Conversion failed Whoops");
